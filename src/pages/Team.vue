<template>
  <div class="container main-content text-white">
      ...
      <div class="col-lg-12 col-xxl-10 mx-auto">
        ...
        <div class="row">
          <div class="col-lg-6" v-for="n in 4">
            <div class="d-flex flex-column flex-lg-row ps-lg-5 mb-5">
              <div class="team-member-circle">
                <img :src="`./../src/assets/img/team_member_${n}.png`" style="width: 100%;"/>
              </div>
